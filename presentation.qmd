...
## Course ratings from ETH-Zurich
...
## MovieLens Data [@Harper2016]

```{julia}
#| echo: false
using Random
ratings = DataFrame(eudataset(:ratings); copycols=true)
movies = DataFrame(eudataset(:movies); copycols=true)
...
ml_model = lmm(ml_genre, ml_sample; progress=isinteractive())
println(ml_model)
```
